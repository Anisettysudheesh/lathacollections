      ...
      <div className="specialties-section">
        ...
        <div className="specialties-content">
          ...
          <div className="specialties-header">
            <div className="specialties-title-container">
              <h2 className="specialties-title">Our Specialties</h2>
            </div>
            <div className="specialties-subtitle-container">
              <p className="specialties-subtitle">
                Discover why Latha Collections stands out with our commitment to
          ...
          <div className="specialties-cards-wrapper">
                                  <div><img  className="manufacturing-logo" src={manufacturinglogo} ></img></div>
            ...
            <div className="specialties-cards-container">
              ...
              <div className="specialty-card">
                ...
                <div className="card-content">
                  <div className="card-title-container">
                    <h3 className="card-title">Own Manufacturing</h3>
                  </div>
                  <div className="card-description-container">
                    <p className="card-description">
                      We control every aspect of quality and design, ensuring
                      each saree meets our high standards.
                    </p>
                  </div>
              ...
              <div className="specialty-card">
                <div className="card-icon-container">
                   <div><img  className="delivery-logo" src={deliverylogo} ></img></div>
                  <div className="card-icon-wrapper">
                    
                    <svg className="card-icon" viewBox="0 0 24 16" fill="none">
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                ...
                <div className="card-content">
                  ...
                  <div className="card-description-container">
                    ...
                    <p className="card-description">
                      Enjoy complimentary shipping on all orders, delivered
              ...
              <div className="specialty-card">
                ...
                <div className="card-content">
                  <div className="card-title-container">
                    <h3 className="card-title">Special Customer Care</h3>
                  </div>
                  <div className="card-description-container">
                    <p className="card-description">
                      Receive personalized service and dedicated support from
                      our expert team.
                    </p>
                  </div>
                </div>
